...
#ifdef CONFIG_TOUCHSCREEN_FT5X0X_SINGLE
...
#define MAX_POINT                 5
#define FT5406_IIC_SPEED          300*1000    //300*1000
//#define TOUCH_RESET_PIN           RK30_PIN0_PB6 //modify for SCM31X8M //RK29_PIN6_PC3
...
#ifdef CONFIG_LCD_AT056TN53_640x480
...
static void ft5406_queue_work(struct work_struct *work)
{
	...
	//dev_info(&data->client->dev, "ft5406 single report event:x = %d,y = %d,event.pressure = %d--\n",event.x,event.y,event.pressure);
 }
